class Maps < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:${OLP_CLI_VERSION}/maps-cli-${OLP_CLI_VERSION}.tar.gz\?apiKey\=${ARTIFACT_SERVICE_API_KEY}"
  sha256 "${SHA256}"

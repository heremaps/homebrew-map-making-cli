class Maps < Formula
  ...
  url "https://github.com/heremaps/homebrew-map-making-cli/releases/download/18.0.19/maps_cli_2.13-18.0.19.tar.gz"
  sha256 "48c2f9787227270f0e778b0d47e4267b43c362a21916cb4049f13f3f35b973e4"
  version "18.0.19"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.13-18.0.19.jar"
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.13-18.0.19.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end

class Maps < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:17.1.41/maps-cli-17.1.41.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "b1130435a0fa36426b4767223cba7e42ad656c016c8862baddd0897654ad7e0e"
  version "17.1.41"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-17.1.41.jar"
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.12-17.1.41.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end

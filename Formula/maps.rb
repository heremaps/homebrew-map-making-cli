class Maps < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:17.3.3/maps-cli-17.3.3.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "939d9c1dcffc7b78b000b470a852a01b177ef04885f925a096f93beb0de35607"
  version "17.3.3"
  license "Proprietary"
  ...
  def install
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.12-17.3.3.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end

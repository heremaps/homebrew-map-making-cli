class Maps < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:17.1.17/maps-cli-17.1.17.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "57a2147a7f1f2368ae07d0e41b78361d4f1515f87fb57dda9bde92c8cb5ab929"
  version "17.1.17"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-17.1.17.jar"
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.12-17.1.17.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end

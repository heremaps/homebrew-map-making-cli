class Maps < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:17.1.25/maps-cli-17.1.25.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "59c255cd6a8671399e174d2784fc088d325e6868a08b36d01d656d8a51c4e556"
  version "17.1.25"
  license "Proprietary"
  ...
  def install
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.12-17.1.25.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end

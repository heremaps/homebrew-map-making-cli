class Maps < Formula
  ...
  url "https://github.com/heremaps/homebrew-map-making-cli/releases/download/18.0.27/maps_cli_2.13-18.0.27.tar.gz"
  sha256 "665bd7db44e3364f77fc4d9ee6f656d4ba7af906c3460e84e64591f1c6a031a3"
  version "18.0.27"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.13-18.0.27.jar"
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.13-18.0.27.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end

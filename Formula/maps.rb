class Maps < Formula
  ...
  url "https://artifact.api.platform.here.com/v1/references/hrn:here:artifact:::com.here.platform:cli:16.3.113/maps-cli-16.3.113.tar.gz\?apiKey\=84q8N9DRx6YAqyJaXUpr9fhiTnCUIBzvHLpk3QU4Oaw"
  sha256 "547f01f10a78dbf5e7a0275dac9a65dd410834d96f261fd1836b15fc8c850ef9"
  version "16.3.113"
  license "Proprietary"
  ...
  def install
    ...
    libexec.install "cli_2.12-16.3.113.jar"
    ...
    (bin/"maps").write <<~EOS
      ...
      exec "${JAVA_HOME}/bin/java" ${ALLOW_DEEP_REFLECTION:-} -Dfile.encoding=UTF8 -cp "#{libexec}/cli_2.12-16.3.113.jar" "com.here.platform.cli.MapsMain" "$@"
    EOS
  end
